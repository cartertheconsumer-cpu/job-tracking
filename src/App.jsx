...
const INITIAL_JOBS = [
  { id:1, track:"Fast Track", company:"Rivian", role:"Service Support Advisor III", url:"https://careers.rivian.com/careers-home/jobs/28629?lang=en-us", companyUrl:"https://rivian.com", location:"Plymouth, MI", mode:"In-Person", pay:"$24.53-$27.26/hr · Est. $52K-$77K/yr", commute:"~35 min", repvue:"", summary:"Virtual point of contact for Rivian owners -- vehicle education, charging & connectivity, roadside assistance, and service intake via phone, email, chat, and SMS.", dateApplied:"", followUp:"", status:"Applied", notes:"" },
  { id:3, track:"Fast Track", company:"Lucid Motors", role:"Customer Care Specialist", url:"https://jobs.lever.co/lucidmotors?team=Customer%20Care&location=Southfield%2C%20MI", companyUrl:"https://lucidmotors.com", location:"Southfield, MI", mode:"In-Person", pay:"Competitive (check listing)", commute:"~15 min", repvue:"", summary:"Technical support for Lucid owners via phone, email, SMS, and chat -- vehicle troubleshooting, knowledge base documentation, and expert-level product guidance.", dateApplied:"", followUp:"", status:"Watchlist", notes:"" },
  { id:5, track:"Fast Track", company:"Snout, Inc", role:"Business Development Rep", url:"https://jobs.gem.com/snout/", companyUrl:"https://www.snout.pet", location:"Troy, MI", mode:"In-Person", pay:"$3,750/mo then $45K base / $90K OTE uncapped", commute:"~20 min", repvue:"", summary:"Outbound pipeline generation for a VC-backed vet wellness SaaS -- prospecting into veterinary practices via phone, email, LinkedIn, and in-person to book discovery meetings. Contract-to-hire.", dateApplied:"", followUp:"", status:"Applied", notes:"" },
  { id:23, track:"Fast Track", company:"Percepta", role:"EV Customer Experience Specialist", url:"https://www.percepta.com/careers/", companyUrl:"https://www.percepta.com", location:"Allen Park, MI", mode:"In-Person", pay:"Competitive hourly + benefits", commute:"~25 min from Ferndale", repvue:"", summary:"Support EV customers via phone, video chat, and online chat for an innovative mobility program. Provide expert product knowledge, troubleshoot issues, and build trust as a skilled advisor.", dateApplied:"", followUp:"", status:"Watchlist", notes:"EV-specific role at a TTEC joint venture. Great fit alongside your other EV applications." },
  { id:24, track:"Fast Track", company:"Carhartt", role:"Account Service Representative I", url:"https://careers.carhartt.com/search/?q=account+service+representative", companyUrl:"https://www.carhartt.com", location:"Dearborn, MI (Remote)", mode:"Remote", pay:"$39K-$52K base", commute:"Remote", repvue:"", summary:"Manage and resolve order processing issues for assigned retail accounts -- monitor order pool, manage fill rates, communicate availability issues, and coordinate with Sales, Planning, and logistics. Iconic Michigan brand.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Remote, Michigan-based company. 1-2 yrs customer service required -- you exceed this." },
  { id:6, track:"Tech Sales", company:"HubSpot", role:"Outbound BDR", url:"https://www.hubspot.com/careers/jobs?hubs_signup-cta=careers-nav-cta&page=1#office=remote;department=sales;roleType=individual-contributor;", companyUrl:"https://www.hubspot.com", location:"Remote (US)", mode:"Remote", pay:"$55K base / ~$80K OTE · Top: $120K-$170K", commute:"Remote", repvue:"84", summary:"Strategic outreach to prospective customers -- uncover pain points, qualify leads, and book meetings for AEs. 3-level BDR career progression. No prior SDR experience required.", dateApplied:"", followUp:"", status:"Watchlist", notes:"" },
  { id:7, track:"Tech Sales", company:"Gong", role:"SDR", url:"https://www.gong.io/company/careers/#open-positions", companyUrl:"https://www.gong.io", location:"NOT AVAILABLE DETROIT", mode:"Hybrid", pay:"~$62.5K base / $90K OTE", commute:"Remote/Hybrid", repvue:"88", summary:"Generate pipeline for a top revenue intelligence platform -- prospect into target accounts, qualify leads, and work with the product you sell daily. ~65% quota attainment.", dateApplied:"", followUp:"", status:"Watchlist", notes:"" },
  { id:8, track:"Tech Sales", company:"Atlassian", role:"SDR", url:"https://www.atlassian.com/company/careers/all-jobs?team=Sales&location=United%20States", companyUrl:"https://www.atlassian.com", location:"Remote Eligible", mode:"Remote", pay:"$67K base / $100K OTE · Top: $150K-$200K", commute:"Remote", repvue:"85", summary:"Build pipeline for Jira, Confluence, and Trello -- multi-channel outreach using Salesforce, Gong, Outreach, and LinkedIn Navigator. No prior SDR experience required.", dateApplied:"", followUp:"", status:"Watchlist", notes:"" },
  { id:9, track:"Tech Sales", company:"ZoomInfo", role:"SDR", url:"https://www.zoominfo.com/about/careers#job-listings", companyUrl:"https://www.zoominfo.com", location:"Hybrid", mode:"Hybrid", pay:"Competitive (verify on RepVue)", commute:"Remote/Hybrid", repvue:"86", summary:"Prospect into target accounts using ZoomInfo's own data platform -- qualify leads and generate pipeline for the AE team. B2B intelligence tools used daily.", dateApplied:"", followUp:"", status:"Watchlist", notes:"" },
  { id:10, track:"Tech Sales", company:"UserGems", role:"SDR/BDR", url:"https://www.usergems.com/careers#open-roles", companyUrl:"https://www.usergems.com", location:"Remote", mode:"Remote", pay:"Verify on RepVue", commute:"Remote", repvue:"94", summary:"AI pipeline generation platform tracking buyer job changes. One of the highest-rated sales orgs on RepVue (94 score, 7 Reppy Awards). Fully remote, VC-backed, growth-stage.", dateApplied:"", followUp:"", status:"Watchlist", notes:"" },
  { id:18, track:"Tech Sales", company:"Datadog", role:"Sales Development Representative", url:"https://careers.datadoghq.com/detail/6399770/?gh_jid=6399770", companyUrl:"https://www.datadoghq.com", location:"Denver / Remote-eligible", mode:"Hybrid", pay:"Competitive OTE · Top SDRs promote to AE", commute:"Remote/Hybrid", repvue:"83", summary:"Prospect, qualify, and generate leads for Datadog's cloud monitoring and security platform. Strong SDR-to-AE promotion track with top-tier sales training.", dateApplied:"", followUp:"", status:"Watchlist", notes:"RepVue: 83 score, 4.1 future outlook. Check if remote-eligible for MI." },
  { id:19, track:"Tech Sales", company:"Wasabi Technologies", role:"Business Development Representative", url:"https://www.wasabi.com/company/careers#openings", companyUrl:"https://www.wasabi.com", location:"Remote (US)", mode:"Remote", pay:"~$50K base / $80K OTE", commute:"Remote", repvue:"84", summary:"Prospect and qualify leads for Wasabi's cloud storage platform -- a fast-growing competitor to AWS S3. Fully remote, growth-stage company.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Cloud storage -- good talking point given your tech curiosity and AI fluency." },
  { id:20, track:"Tech Sales", company:"ClearCompany", role:"Sales Development Representative", url:"https://www.clearcompany.com/careers#openpositions", companyUrl:"https://www.clearcompany.com", location:"Remote (US)", mode:"Remote", pay:"Competitive base + commission", commute:"Remote", repvue:"80", summary:"Generate pipeline for a leading HR tech / talent management SaaS platform. Outbound prospecting via phone, email, and LinkedIn to HR leaders. Fully remote.", dateApplied:"", followUp:"", status:"Watchlist", notes:"HR tech -- your communication background from MSU is a direct selling point here." },
  { id:21, track:"Tech Sales", company:"Lumivero", role:"Business Development Representative", url:"https://www.lumivero.com/company/careers/", companyUrl:"https://www.lumivero.com", location:"Remote (US)", mode:"Remote", pay:"~$55K base / OTE verify listing", commute:"Remote", repvue:"78", summary:"Outbound prospecting to academic institutions and Fortune 1000 companies for market-leading research and decision-making software.", dateApplied:"", followUp:"", status:"Watchlist", notes:"MSU grad angle -- you understand the academic buyer persona firsthand." },
  { id:28, track:"Tech Sales", company:"Hostaway", role:"SDR (April Hiring Class)", url:"https://careers.hostaway.com/o/sales-development-representative-100-remote-north-america", companyUrl:"https://www.hostaway.com", location:"Remote (US)", mode:"Remote", pay:"~$50K base / $80K OTE · Top: $130K-$150K", commute:"Remote", repvue:"", summary:"Property management SaaS for short-term rentals (Airbnb, Vrbo, Booking.com). Outbound prospecting via cold calling, email, and social selling. April class closes April 11th. Unicorn-status, high-growth. 64/36 pay split.", dateApplied:"", followUp:"", status:"Watchlist", notes:"URGENT -- April class closing April 11th, 2026. Apply ASAP." },
  { id:29, track:"Tech Sales", company:"OnPay", role:"Sales Development Representative", url:"https://www.onpay.com/about/careers", companyUrl:"https://www.onpay.com", location:"Remote (US)", mode:"Remote", pay:"Base + bonus + stock options", commute:"Remote", repvue:"", summary:"Fast-growing payroll & HR SaaS platform. SDR team fields inbound inquiries and supports AEs. Top-rated payroll product. 4 weeks PTO, full benefits, 401(k) match, remote flexibility.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Mortgage background = direct advantage. You understand payroll, small biz pain points, and financial products." },
  { id:30, track:"Tech Sales", company:"SambaSafety", role:"Sales Development Representative", url:"https://www.sambasafety.com/about-us/careers#openings", companyUrl:"https://www.sambasafety.com", location:"Remote (US)", mode:"Remote", pay:"Competitive base + commission", commute:"Remote", repvue:"", summary:"Driver risk management SaaS platform. Engage prospects, qualify leads, and support AE team. 4.9 stars on Glassdoor, recognized as Top Workplace. Uses Salesforce, SalesLoft, LinkedIn Navigator, ZoomInfo.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Glassdoor 4.9 stars. Strong culture. Straightforward product to learn." },
  { id:31, track:"Tech Sales", company:"Canonical", role:"Sales Development Representative", url:"https://canonical.com/careers/all?search=sales+development", companyUrl:"https://canonical.com", location:"Remote (Global)", mode:"Remote", pay:"Competitive base + commission", commute:"Remote", repvue:"", summary:"The company behind Ubuntu -- one of the most widely used open-source platforms globally. SDRs drive sales inquiries for cloud solutions. Fully remote, global team.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Open-source + cloud. Your tech curiosity and AI fluency are selling points." },
  { id:32, track:"Tech Sales", company:"Motive", role:"Sales Development Representative", url:"https://gomotive.com/careers/?department=Sales%20Development", companyUrl:"https://gomotive.com", location:"Remote-eligible", mode:"Remote", pay:"Competitive OTE · Strong SDR to AE track", commute:"Remote", repvue:"", summary:"Fleet management and IoT platform -- telematics, safety, spend management for physical economy businesses. Growing aggressively, hires SDRs in classes with structured promotion to AE.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Check careers page for current SDR class openings. Strong SDR-to-AE pipeline." },
  { id:38, track:"Tech Sales", company:"Nooks", role:"Sales Development Representative", url:"https://www.nooks.ai/careers#open-roles", companyUrl:"https://www.nooks.ai", location:"Remote (US)", mode:"Remote", pay:"~$70K base / $115K OTE · Top: $180K-$210K", commute:"Remote", repvue:"", summary:"AI-powered outbound sales platform (parallel dialer + virtual salesfloor). SDRs use the product daily. ~84% quota attainment. 4.4/5 compensation rating on Glassdoor.", dateApplied:"", followUp:"", status:"Watchlist", notes:"HIGH OTE ceiling. They want 18mo+ SaaS SDR exp but your 6.5yr consultative sales + outbound volume at UWM is a strong case." },
  { id:39, track:"Tech Sales", company:"LegalOn Technologies", role:"Sales Development Representative", url:"https://legalontech-inc.rippling-ats.com/", companyUrl:"https://www.legalon.ai", location:"Remote (US)", mode:"Remote", pay:"Competitive base + commission", commute:"Remote", repvue:"", summary:"Leader in AI contract review software for legal teams. SDRs identify potential customers and generate pipeline. AI-native product, high-growth. Remote-first.", dateApplied:"", followUp:"", status:"Watchlist", notes:"AI contract review SaaS. Your multi-party process experience (closings, compliance) maps well to selling to legal teams." },
  { id:40, track:"Tech Sales", company:"OptiSigns", role:"Business Development Representative", url:"https://www.indeed.com/cmp/Optisigns-Inc./jobs", companyUrl:"https://www.optisigns.com", location:"Houston, TX (Remote-eligible)", mode:"Remote", pay:"$50K base / $80K+ OTE (uncapped)", commute:"Remote", repvue:"", summary:"Digital signage SaaS on the front lines of expansion. BDR generates net-new pipeline through outbound prospecting. Designed as a springboard to full-cycle AE role. Uncapped commission.", dateApplied:"", followUp:"", status:"Watchlist", notes:"BDR-to-AE springboard. $50K base + uncapped commission. Clear promotion path." },
  { id:41, track:"Tech Sales", company:"SingleFile", role:"Business Development Representative", url:"https://www.indeed.com/cmp/Singlefile/jobs", companyUrl:"https://www.singlefile.com", location:"Remote (US)", mode:"Remote", pay:"Competitive base + commission", commute:"Remote", repvue:"", summary:"AI-enabled legal tech solving a $50B+ problem in compliance workflows, entity management, and Secretary of State filings. Outbound BDR: 80+ calls/day, multi-channel. Hiring multiple BDRs.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Your UWM outbound volume (80-100+ daily touches) is exactly what they want. Legal/compliance tech with clear AE growth path." },
  { id:42, track:"Tech Sales", company:"CeriFi", role:"Sales Development Representative", url:"https://www.cerifi.com/about-us/careers/", companyUrl:"https://www.cerifi.com", location:"Remote (US)", mode:"Remote", pay:"Competitive base + commission", commute:"Remote", repvue:"", summary:"Financial education and certification platform. SDRs prospect into senior-level decision makers and start high-quality conversations. Financial services background is a direct advantage.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Financial education SaaS. Your NMLS license + mortgage background = instant credibility with their buyer persona." },
  { id:12, track:"WFH Now", company:"Concentrix", role:"Inside Sales Rep -- Financial (Remote)", url:"https://jobs.concentrix.com/job-search/?search=inside+sales+financial&country=United+States", companyUrl:"https://www.concentrix.com", location:"Remote (MI eligible)", mode:"Remote", pay:"~$16-$20/hr · Est. $33K-$42K + incentives", commute:"Remote", repvue:"", summary:"Inbound/outbound sales and service for financial clients from home. Equipment and paid training provided. 80% of managers promoted from within. Fast interview process.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Check for seasonal vs. permanent postings -- permanent preferred." },
  { id:15, track:"WFH Now", company:"SelectQuote", role:"Sales Development Advisor (Remote)", url:"https://www.selectquote.com/about-us/careers/#openpositions", companyUrl:"https://www.selectquote.com", location:"Remote", mode:"Remote", pay:"Base + commission (verify listing)", commute:"Remote", repvue:"", summary:"Qualify inbound leads for insurance products -- warm leads, no cold calling. No insurance license needed to start. High-volume, fast-paced phone sales environment.", dateApplied:"", followUp:"", status:"Watchlist", notes:"No license required -- good quick-start option." },
  { id:16, track:"WFH Now", company:"BAO Inc.", role:"SDR / Outbound Rep (Remote)", url:"https://www.bao-inc.com/careers", companyUrl:"https://www.bao-inc.com", location:"Remote", mode:"Remote", pay:"Base + uncapped commission", commute:"Remote", repvue:"", summary:"Book qualified meetings on behalf of major tech companies like SAP, Amazon, Salesforce, and Cisco. Outbound calling into enterprise accounts. Great resume builder for tech sales.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Strong stepping stone into tech sales AE roles." },
  { id:17, track:"WFH Now", company:"Agent Alliance", role:"Customer Service/Sales Rep (WFH)", url:"https://www.indeed.com/cmp/Agent-Alliance/jobs", companyUrl:"https://www.agent-alliance.com", location:"Remote (MI -- Canton/Ann Arbor area)", mode:"Remote", pay:"Competitive hourly", commute:"Remote", repvue:"", summary:"Remote customer service and sales support role -- handle inbound inquiries, cross-sell products, and provide account assistance. Low barrier to entry, fast hiring.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Check Indeed for latest active postings -- they hire on rolling basis." },
  { id:27, track:"WFH Now", company:"Henry Ford Health", role:"Patient Services Specialist I (Remote)", url:"https://henryford.referrals.selectminds.com/jobs/search?utf8=%E2%9C%93&query=patient+services+specialist&location=", companyUrl:"https://www.henryford.com", location:"Troy, MI (Remote for MI residents)", mode:"Remote", pay:"Competitive hourly + healthcare benefits", commute:"Remote", repvue:"", summary:"Remote patient-facing role handling scheduling, insurance verification, and patient inquiries via phone. Michigan residents only. Full benefits from a major health system.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Healthcare industry -- stable employer, great benefits. Remote for MI residents." },
  { id:33, track:"WFH Now", company:"Raymond James", role:"New Accounts Service Associate", url:"https://www.raymondjames.com/careers/search-jobs?query=new+accounts+service+associate&location=southfield", companyUrl:"https://www.raymondjames.com", location:"Southfield, MI", mode:"In-Person", pay:"Paid training + benefits", commute:"~15 min from Ferndale", repvue:"", summary:"Fortune 500 financial services firm with a major operations hub in Southfield. Paid training class starting June 2026. Client-facing role supporting financial advisors.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Paid training starts June 2026 -- apply now for pipeline. Southfield is one of their 3 main hubs." },
  { id:34, track:"WFH Now", company:"Raymond James", role:"Customer Account Associate", url:"https://www.raymondjames.com/careers/search-jobs?query=customer+account+associate&location=southfield", companyUrl:"https://www.raymondjames.com", location:"Southfield, MI", mode:"In-Person", pay:"Est. $38K-$56K", commute:"~15 min from Ferndale", repvue:"", summary:"Client-facing operations role at Raymond James Southfield hub. Handle customer accounts, transfers, and admin support for financial advisors. Stable Fortune 500 employer.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Currently posted and actively hiring. Your mortgage/finance background is a direct fit." },
  { id:35, track:"WFH Now", company:"NTT DATA", role:"Customer Care Associate", url:"https://careers.nttdata.com/global/en/search-results?keywords=customer+care+associate&location=Detroit", companyUrl:"https://www.nttdata.com", location:"Detroit, MI (Remote)", mode:"Remote", pay:"$20/hr", commute:"Remote", repvue:"", summary:"Global IT services company. Remote customer care role based in Detroit metro. $20/hr. Better resume line than generic call center -- NTT DATA is a recognized global tech brand.", dateApplied:"", followUp:"", status:"Watchlist", notes:"$20/hr remote. Global IT services company -- good brand on resume while pursuing tech sales." },
  { id:37, track:"WFH Now", company:"Concentrix", role:"Customer Service / Tech Support -- Tech Products (Remote)", url:"https://jobs.concentrix.com/job-search/?search=tech+support&country=United+States", companyUrl:"https://www.concentrix.com", location:"Remote (MI eligible)", mode:"Remote", pay:"~$16-$20/hr", commute:"Remote", repvue:"", summary:"Tech product support from home -- troubleshoot and assist customers with technology products via phone and chat. Equipment provided, paid training.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Tech-focused version of Concentrix role. Apply to multiple Concentrix listings to increase odds." },
  { id:43, track:"WFH Now", company:"FinTech CRM (Series B)", role:"Remote SDR", url:"https://www.ziprecruiter.com/Jobs/Remote-Sdr", companyUrl:"", location:"Remote (US)", mode:"Remote", pay:"$50K base / $85K OTE + benefits + 401(k)", commute:"Remote", repvue:"", summary:"Series B fintech CRM for financial advisors. 100+ employees, remote-first. Inbound lead handling + outbound prospecting. Financial services product knowledge is a major plus.", dateApplied:"", followUp:"", status:"Watchlist", notes:"Fintech CRM. Your mortgage/financial services background is a direct match. Apply via ZipRecruiter." },
  { id:44, track:"WFH Now", company:"Interplay Learning", role:"Sales Development Representative", url:"https://www.interplaylearning.com/careers#positions", companyUrl:"https://www.interplaylearning.com", location:"Remote (US)", mode:"Remote", pay:"$80K-$90K OTE (base + uncapped commission)", commute:"Remote", repvue:"", summary:"VR/3D simulation platform for skilled trades training (HVAC, plumbing, electrical). B2B SaaS selling to workforce development buyers. Austin-based, 100% remote eligible.", dateApplied:"", followUp:"", status:"Watchlist", notes:"EdTech/workforce SaaS. $80-90K OTE is strong. Your consultative selling approach maps well." },
];

const EMPTY_JOB = { id:0, track:"Fast Track", company:"", role:"", url:"", companyUrl:"", location:"", mode:"In-Person", pay:"", commute:"", repvue:"", summary:"", dateApplied:"", followUp:"", status:"Watchlist", notes:"" };
  ...
  return (
    <div style={{
      ...
      <div style={{ display:"flex", alignItems:"center", gap:14, marginTop:10, flexWrap:"wrap" }}>
        ...
        {job.url && <a href={job.url} target="_blank" rel="noopener noreferrer" style={{ fontSize:12, color:"#fff", background:"#1a2744", textDecoration:"none", fontWeight:600, padding:"4px 12px", borderRadius:6 }}>Apply ↗</a>}
        {job.companyUrl && <a href={job.companyUrl} target="_blank" rel="noopener noreferrer" style={{ fontSize:12, color:"#2c5f8a", textDecoration:"none", fontWeight:500 }}>Company ↗</a>}
      </div>
...
export default function App() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const r = await window.storage.get("jst_jobs_v7");
        if (r?.value) { setJobs(JSON.parse(r.value)); }
        else { setJobs(INITIAL_JOBS); await window.storage.set("jst_jobs_v7", JSON.stringify(INITIAL_JOBS)); }
      } catch { setJobs(INITIAL_JOBS); }
      setLoaded(true);
    })();
  }, []);

  const save = async (updated) => { setJobs(updated); try { await window.storage.set("jst_jobs_v7", JSON.stringify(updated)); } catch {} };
            ...
            <div style={{
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16 }}>
                ...
                <FormField label="Company URL">
                  <input value={form.companyUrl||""} onChange={e=>setForm({...form,companyUrl:e.target.value})} placeholder="https://company.com" style={IS()} />
                </FormField>
