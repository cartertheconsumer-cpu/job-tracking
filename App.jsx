...
function JobCard({ job, aiPanel, setAiPanel, aiMode, setAiMode, aiResult, setAiResult, jdInput, setJdInput, aiLoading, runAI, updateStatus, openForm, deleteJob, editingNotes, setEditingNotes, saveNotes, isSelected, onToggleSelect }) {
  ...
  return (
    <div style={{ background:"var(--color-background-primary)", border:`0.5px solid ${isSelected?"#6366F1":"var(--color-border-tertiary)"}`, borderRadius:"var(--border-radius-lg)", padding:"14px 16px", marginBottom:10, transition:"border-color 0.15s ease" }}>
